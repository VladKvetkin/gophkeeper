...
import (
	...
	storage "github.com/VladKvetkin/gophkeeper/internal/server/storage"
...
func (m *Mockrepository) SaveUserData(ctx context.Context, userID int64, name string, dataType int64, data []byte) error {
	m.ctrl.T.Helper()
